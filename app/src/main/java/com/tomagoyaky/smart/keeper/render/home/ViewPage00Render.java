...
public class ViewPage00Render extends AbstractItemRender{

    private static ViewPage00Render viewPage00Render;
    public ViewPage00Render(Activity activity, SmartContext smartContext) {
        super(activity, smartContext);
    }

    public static ViewPage00Render INSTANCE(Activity activity, SmartContext smartContext) {
        if(viewPage00Render == null){
            viewPage00Render = new ViewPage00Render(activity, smartContext);
        }
        return viewPage00Render;
    }
