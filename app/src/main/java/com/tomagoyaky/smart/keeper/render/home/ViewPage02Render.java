...
public class ViewPage02Render extends AbstractItemRender{

    private static ViewPage02Render viewPage02Render;
    public ViewPage02Render(Activity activity, SmartContext smartContext) {
        super(activity, smartContext);
    }

    public static ViewPage02Render INSTANCE(Activity activity, SmartContext smartContext) {
        if(viewPage02Render == null){
            viewPage02Render = new ViewPage02Render(activity, smartContext);
        }
        return viewPage02Render;
    }
