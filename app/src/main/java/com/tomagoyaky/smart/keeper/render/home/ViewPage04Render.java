...
public class ViewPage04Render extends AbstractItemRender{

    private static ViewPage04Render viewPage04Render;
    public ViewPage04Render(Activity activity, SmartContext smartContext) {
        super(activity, smartContext);
    }

    public static ViewPage04Render INSTANCE(Activity activity, SmartContext smartContext) {
        if(viewPage04Render == null){
            viewPage04Render = new ViewPage04Render(activity, smartContext);
        }
        return viewPage04Render;
    }
